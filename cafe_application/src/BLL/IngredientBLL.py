...
class IngredientBLL(Manager[Ingredient]):
    def __init__(self):
        try:
            ...
            self.__ingredientList = self.searchIngredients()
        except Exception:
            pass
    ...
    def addIngredient(self, ingredient: Ingredient) -> bool:
        if (self.getIndex(ingredient, "NAME", self.getIngredientList)) != -1:
    ...
    def getAutoID(self) -> str:
        return super().getAutoID("ING", 3, self.__ingredientList)
